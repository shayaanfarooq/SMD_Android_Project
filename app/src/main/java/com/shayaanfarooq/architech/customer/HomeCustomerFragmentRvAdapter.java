...
public class HomeCustomerFragmentRvAdapter extends RecyclerView.Adapter<HomeCustomerFragmentRvAdapter.MyViewHolder> {
    ...
    public HomeCustomerFragmentRvAdapter(ArrayList<FloorPlanRecyclerObject> listOfFloorPlans, Context context)
    {
...
//        holder.coverImage.setImageResource(resIdCoverImage);
        Picasso.get()
                .load(listOfFloorPlans.get(position).getPaths().get(0)).fit().centerCrop()
    ...
    public void filteredList(ArrayList<FloorPlanRecyclerObject> list){
