...
public class FavCustomerFragmentRvAdapter extends RecyclerView.Adapter<FavCustomerFragmentRvAdapter.MyViewHolder> {
    ...
    public FavCustomerFragmentRvAdapter(ArrayList<FloorPlanRecyclerObject> listOfFloorPlans, Context context) {
        this.listOfFloorPlans=listOfFloorPlans;
        this.context= context;
    }

    public void setListOfFloorPlans(ArrayList<FloorPlanRecyclerObject> listOfFloorPlans) {
        this.listOfFloorPlans = listOfFloorPlans;
    }
